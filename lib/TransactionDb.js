...
var encodedData = require('soop').load('Sevencore/util/EncodedData', {
  base58: base58
});
var versionedData = require('soop').load('Sevencore/util/VersionedData', {
  parent: encodedData
});

var Address = require('soop').load('Sevencore/lib/Address', {
